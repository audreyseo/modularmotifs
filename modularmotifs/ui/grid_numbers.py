...
class GridNumbers:
    ...
    def add_left(self, num: int):
        self.__left.append(self.__left_numbers.create_text(self.__small_w * 0.9, (num + 0.5) * self.__small_h, text=str(num), anchor="e", font=self.__font))
        pass
    
    def add_right(self, num: int):
        self.__right.append(self.__right_numbers.create_text(self.__small_w * 0.1, (num + 0.5) * self.__small_h, text=str(num), anchor="w", font=self.__font))
        pass
    
    def add_bottom(self, num: int):
        self.__bottom.append(self.__bottom_numbers.create_text((num + 0.5) * self.__small_w, self.__small_h * 0.5, text=str(num), font=self.__font))
        pass
    
    def add_top(self, num: int):
        self.__top.append(self.__top_numbers.create_text((num + 0.5) * self.__small_w, self.__small_h * 0.5, text=str(num), font=self.__font))
        pass
